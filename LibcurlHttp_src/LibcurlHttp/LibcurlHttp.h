...
public:
	...
	//提交表单
	// url, fieldtype1(1:普通字段；2:file字段), fieldname1, fieldvalue1, [如果fieldtype1==2则存在]fileName1,    fieldtype2(1:普通字段；2:file字段), fieldname2, fieldvalue2, [如果fieldtype2==1则存在]fileName2, ……, NULL
