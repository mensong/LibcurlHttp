...
load_mlang()
{
    ...
    if (!h)
        return FALSE;
    ConvertINetString = (CONVERTINETSTRING)GetProcAddress(h, (LPCSTR)("ConvertINetString"));
    ConvertINetMultiByteToUnicode = (CONVERTINETMULTIBYTETOUNICODE)GetProcAddress(h, (LPCSTR)("ConvertINetMultiByteToUnicode"));
    ConvertINetUnicodeToMultiByte = (CONVERTINETUNICODETOMULTIBYTE)GetProcAddress(h, (LPCSTR)("ConvertINetUnicodeToMultiByte"));
    IsConvertINetStringAvailable = (ISCONVERTINETSTRINGAVAILABLE)GetProcAddress(h, (LPCSTR)("IsConvertINetStringAvailable"));
    LcidToRfc1766A = (LCIDTORFC1766A)GetProcAddress(h, (LPCSTR)("LcidToRfc1766A"));
    Rfc1766ToLcidA = (RFC1766TOLCIDA)GetProcAddress(h, (LPCSTR)("Rfc1766ToLcidA"));
    return TRUE;
}
